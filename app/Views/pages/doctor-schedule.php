<section class="page-banner">
  <div class="container">
    ...
    <div class="breadcrumb"><a href="index.php">Home</a> / Doctor Schedule</div>
  </div>
</section>
    ...
    <div class="table-scroll">
      <table>
        ...
        <tr>
          ...
          <td><a href="book-appointment.php?doctor=<?php echo urlencode($doc['name']); ?>" style="color:var(--primary); font-weight:600;">Book</a></td>
        </tr>
        <?php endforeach; ?>
      </table>
    </div>
