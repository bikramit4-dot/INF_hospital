<section class="page-banner">
  <div class="container">
    ...
    <div class="breadcrumb" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100"><a href="index.php">Home</a> / Lab Report</div>
  </div>
</section>
...
<section class="section" id="view">
  <div class="container" style="max-width:760px;">
    ...
    <div class="form-box mb-20" data-aos="zoom-in" data-aos-duration="1200">
      ...
      <?php endif; ?>
      <form method="POST" action="lab-report.php#view">
