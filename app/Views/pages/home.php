<section class="hero">
  ...
  <div class="container hero-inner">
    ...
    <div class="hero-buttons">
      <a href="book-appointment.php" class="btn btn-primary" data-aos="zoom-in" data-aos-duration="1200">Book Appointment</a>
      <a href="services.php#emergency" class="btn btn-outline" data-aos="zoom-in" data-aos-duration="1200" data-aos-delay="100">Emergency Services</a>
    </div>
  </div>
</section>
...
<section class="section">
  <div class="container">
          ...
          <div class="carousel-slide">
            <div class="card service-card">
              ...
              <div class="service-card-body">
                ...
                <a class="view-more" href="services.php#<?php echo e($s['slug']); ?>">View More <span class="vm-arrow">&rarr;</span></a>
              </div>
            </div>
          </div>
          <?php endforeach; ?>
    ...
    <?php endif; ?>
    <p class="text-center mt-20"><a href="services.php" class="btn btn-secondary btn-view-all" data-aos="zoom-in" data-aos-duration="1200">View All Services</a></p>
  </div>
</section>
...
<section class="section section-alt">
  <div class="container">
          ...
          <div class="carousel-slide">
            <div class="card doctor-card">
              ...
              <div class="doctor-info">
                ...
                <a class="view-more" href="book-appointment.php?doctor=<?php echo (int)$doc['id']; ?>">Book Appointment <span class="vm-arrow">&rarr;</span></a>
              </div>
            </div>
          </div>
          <?php endforeach; ?>
    ...
    <?php endif; ?>
    <p class="text-center mt-20"><a href="find-doctor.php" class="btn btn-secondary" data-aos="zoom-in" data-aos-duration="1200">Find a Doctor</a></p>
  </div>
</section>
...
<section class="section">
  <div class="container">
    ...
    <p class="text-center mt-20"><a href="health-packages.php" class="btn btn-secondary" data-aos="zoom-in" data-aos-duration="1200">View All Packages</a></p>
  </div>
</section>
