<section class="page-banner">
  <div class="container">
    ...
    <div class="breadcrumb" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100"><a href="<?php echo e(site_url('pages/index.php')); ?>">Home</a> / <?php echo e(content('find-doctor', 'banner_title')); ?></div>
  </div>
</section>
