<section class="page-banner">
  <div class="container">
    ...
    <div class="breadcrumb" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100"><a href="<?php echo e(site_url('pages/pages/index.php'))); ?>">Home</a> / Find a Doctor</div>
  </div>
</section>
...
<section class="section">
  <div class="container">
    <div class="tabs" data-aos="fade-up" data-aos-duration="1000">
      <a href="<?php echo e(site_url('pages/pages/find-doctor.php?by=name'))); ?>" class="tab-btn <?php echo $by=='name'?'active':''; ?>">Search by Name</a>
      <a href="<?php echo e(site_url('pages/pages/find-doctor.php?by=department'))); ?>" class="tab-btn <?php echo $by=='department'?'active':''; ?>">Search by Department</a>
      <a href="<?php echo e(site_url('pages/pages/find-doctor.php?by=specialty'))); ?>" class="tab-btn <?php echo $by=='specialty'?'active':''; ?>">Search by Specialty</a>
    </div>

    <div class="form-box mb-20" data-aos="zoom-in" data-aos-duration="1200">
      <form method="GET" action="<?php echo e(site_url('pages/pages/find-doctor.php'))); ?>" class="form-row" style="align-items:end;">
