<section class="page-banner">
  <div class="container">
    <h1>Contact Us</h1>
    <div class="breadcrumb"><a href="<?php echo e(site_url('pages/pages/index.php'))); ?>">Home</a> / Contact Us</div>
  </div>
</section>
...
<section class="section">
  <div class="container grid grid-2">
    ...
    <div class="form-box">
      ...
      <?php endforeach; ?>
      <form method="POST" action="<?php echo e(site_url('pages/pages/contact.php'))); ?>">
