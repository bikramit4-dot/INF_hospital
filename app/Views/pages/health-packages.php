<section class="page-banner">
  <div class="container">
    ...
    <div class="breadcrumb"><a href="<?php echo e(site_url('pages/pages/index.php'))); ?>">Home</a> / Health Packages</div>
  </div>
</section>
  ...
  <div class="container">
    ...
    <div class="grid grid-3">
      ...
      <div class="card">
        ...
        <a href="<?php echo e(site_url('pages/pages/book-appointment.php'))); ?>" class="btn btn-secondary">Book This Package</a>
      </div>
      <?php endforeach; ?>
    </div>
  </div>
