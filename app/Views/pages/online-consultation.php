<section class="page-banner">
  <div class="container">
    ...
    <div class="breadcrumb"><a href="<?php echo e(site_url('index.php')); ?>">Home</a> / Online Consultation</div>
  </div>
</section>
...
<section class="section">
  <div class="container grid grid-2">
    ...
    <div class="form-box">
      ...
      <?php endforeach; ?>
      <form method="POST" action="<?php echo e(site_url('online-consultation.php')); ?>">
