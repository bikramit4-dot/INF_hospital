<section class="page-banner">
  <div class="container">
    ...
    <div class="breadcrumb" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100"><a href="<?php echo e(site_url('index.php')); ?>">Home</a> / International Patients</div>
  </div>
</section>
...
<section class="cta">
  <div class="container">
    ...
    <a href="<?php echo e(site_url('contact.php')); ?>" class="btn" style="background:#fff;color:var(--accent);" data-aos="zoom-in" data-aos-duration="1200" data-aos-delay="200">Contact Us</a>
  </div>
</section>
