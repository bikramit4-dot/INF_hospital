<section class="page-banner">
  <div class="container">
    ...
    <div class="breadcrumb"><a href="<?php echo e(site_url('pages/index.php')); ?>">Home</a> / <?php echo e(content('book-appointment', 'banner_title')); ?></div>
  </div>
</section>
  ...
  <div class="container" style="max-width:820px;">
    ...
    <?php if ($success): ?>
      <div class="form-box text-center">
        ...
        <a href="<?php echo e(site_url('pages/book-appointment.php')); ?>" class="btn btn-secondary mt-20">Book Another Appointment</a>
      </div>
    <?php else: ?>
    ...
    <div class="form-box">
      <form method="POST" action="<?php echo e(site_url('pages/book-appointment.php')); ?>">
